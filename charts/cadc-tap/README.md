...
| config.datalinkPayloadUrl | string | `"https://github.com/lsst/sdm_schemas/releases/download/v3.2.0/datalink-snippets.zip"` | Datalink payload URL |
...
| tapSchema.image.tag | string | `"v3.2.0"` | Tag of TAP schema image |
